...
#root.button = Button(text="Open", command=openfile).pack()
#root.mainloop()
...
#img = cv.imread('./sampleImage/image.png')
...
def segmentCharacters(seg,lettergray):
    ...
    for i in range(len(seg)):
        ...
        #print("word image list"+wordImgList)
...
###------------------------Visualize segmentation------------------------------#####        
        ...
        #print("WordImgList"+wordImgList)
        for i in wordImgList:
            cv.imwrite("C:/Users/ELCOT-Lenovo/Downloads/Hindi-OCR-master/Hindi-OCR-master/result/characters" + str(counter) +".jpeg",i)
            counter=counter+1
