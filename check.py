...
#labels =['क','ख','घ','च','ज','झ','ट','ठ','ड','त','ध','न','प','र','ल','व','स','ह','क्ष','त्र','अ','इ','उ','ऊ','ए']
...
#for i in segmentation.wordImgList:
    #images = cv2.imread(i)
    image = cv2.resize(images[n], (32,32))
    ...
    result.append(labels[np.argmax(lists)])
